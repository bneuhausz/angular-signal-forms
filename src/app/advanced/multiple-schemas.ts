...
import { form, Control, schema, required, apply } from "@angular/forms/signals";
...
@Component({
  ...
  imports: [MatFormFieldModule, MatInputModule, MatButtonModule, MatDividerModule, JsonPipe, Control],
  template: `
    <form>
      <mat-form-field>
